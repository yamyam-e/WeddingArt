...
<div class="modal fade" id="venderSysMModal" role="dialog"
	...
	<div class="modal-dialog"
		...
		<div class="modal-content">
			<div class="modal-header"
				...
				<h4 class="cursive" style="color: black;">Makeup Modify</h4>
			</div>
			<div class="modal-body"
				style="height: 630px; background: rgba(240, 120, 100, 0.1);">
				<form class="form-horizontal" action="/wedding/vender_systemMModify" method="post" enctype="multipart/form-data" >
				    ...
				    <div class="form-group" align="left">
				      ...
				      <div class="col-sm-9">
				        <input type="text" class="form-control-after" name="name" id="name"
							value="${ vmDtoModal.name }" style="color: black;">
				      </div>
				    </div>
				    <div class="form-group" align="left">
				      <label class="control-label col-sm-2" style="color: black;">내용 : </label>
				      <div class="col-sm-9">
				        <textarea class="form-control-after" rows="3" cols="3" style="color: black;" name="content">${ vmDtoModal.content }
						</textarea>
				      </div>
				    </div>
				    <div class="form-group">
				      ...
				      <div class="col-sm-9">
				        <input type="text" class="form-control-after" name="homeurl" id="homeurl"
							value="${ vmDtoModal.homeurl }" style="color: black;">
				      </div>
				    </div>
				    <div class="form-group">
				      ...
				      <div class="col-sm-9">
				        <input type="text" class="form-control-after" name="address" id="address"
							value="${ vmDtoModal.address }" style="color: black;">
				      </div>
				    </div>
				    <div class="form-group">
				      ...
				      <div class="col-sm-9">
				        <input type="text" class="form-control-after" name="phone" id="phone"
							value="${ vmDtoModal.phone }" style="color: black;">
				      </div>
				    </div>
				    <div class="form-group">
				      ...
				      <div class="col-sm-9">
				        <input type="text" class="form-control-after" name="judge" id="judge"
							value="${ vmDtoModal.judge }" style="color: black;">
				      </div>
				    </div>
				    <div class="form-group" align="left">
