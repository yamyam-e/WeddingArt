...
<body>
	...
	<table class="table table-hover" >
		...
		<tbody style="color: navy;">
			<c:forEach items="${ vender_system_studio }" var="each">
				<tr>
					<td>${ each.num }</td>
					<td align="center">
						<img alt="" width="220px" height="230px" 
						src="/wedding/resources/vender_gallery/vender_studio_gallery/${ each.logo }">
					</td>
					<td>${ each.name }</td>
					<td>
					...
					<td>${ each.judge }</td>
					<td>
						<button type="button" class="btn btn-danger" onclick="javascript:venderSysSMod('${each.num}')"
