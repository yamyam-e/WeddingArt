...
<body style="color: black;">
	...
	<h2 style="color: black;">Tuxedo</h2>
	<div align="right" style="height: 25px;">
		<a href="/wedding/vender_dress_tuxedo">
			<abbr title="World Health Organization">처음 보기</abbr>
		</a>&nbsp;&nbsp;
		<a href="/wedding/vender_dress_tuxedo_selectName">
			<abbr title="World Health Organization">이름순 보기</abbr>
		</a>&nbsp;&nbsp;
		<a href="/wedding/vender_dress_tuxedo_selectPrice">
			<abbr title="World Health Organization">가격순 보기</abbr>
		</a>
	</div>
	<div style="background-color: white;">
		<div class="row">
			<c:forEach var="each" items="${ vender_dress_tuxedo }">
				<div class="col-md-4">
