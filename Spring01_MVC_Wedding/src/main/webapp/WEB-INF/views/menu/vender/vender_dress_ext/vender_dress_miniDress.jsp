...
<body style="color: black;">
	...
	<h2 style="color: black;">MiniDress</h2>
	<div align="right" style="height: 25px;">
		<a href="/wedding/vender_dress_miniDress">
			<abbr title="World Health Organization">처음 보기</abbr>
		</a>&nbsp;&nbsp;
		<a href="/wedding/vender_dress_miniDress_selectName">
			<abbr title="World Health Organization">이름순 보기</abbr>
		</a>&nbsp;&nbsp;
		<a href="/wedding/vender_dress_miniDress_selectPrice">
			<abbr title="World Health Organization">가격순 보기</abbr>
		</a>
	</div>
	<div style="background-color: white;">
		<div class="row">
			<c:forEach var="each" items="${ vender_dress_miniDress }">
				<div class="col-md-4">
					<a href="" class="thumbnail" data-toggle="modal"
						data-target="#exampleModal"
						onclick="javascript:govendermodal('${each.num}','${each.type}')"> <img
						src="/wedding/resources/vender_gallery/vender_dress_gallery/${ each.orgname }"
						alt="Pulpit Rock" style="width: 250px; height: 350px">
