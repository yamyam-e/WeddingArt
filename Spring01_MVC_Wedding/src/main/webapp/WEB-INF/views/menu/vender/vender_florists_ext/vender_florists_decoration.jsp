...
<body style="color: black;">
	...
	<h2 style="color: black;">웨딩 악세서리</h2>
	<div align="right" style="height: 25px;">
		...
		<a href="/wedding/vender_floristsDeco_selectName">
			<abbr title="World Health Organization">이름순 보기</abbr>
		</a>&nbsp;&nbsp;
		<a href="/wedding/vender_floristsDeco_selectPrice">
			<abbr title="World Health Organization">가격순 보기</abbr>
		</a>
	</div>
	<div style="background-color: white;">
		<div class="row">
			<c:forEach var="each" items="${ vender_florists_decoration }">
				<div class="col-md-4">
