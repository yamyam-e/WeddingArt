...
<body style="color: black;">
	<jsp:include page="/WEB-INF/views/menu/vender/vender_dress_ext/vender_dress_modal.jsp"/>
	<h2 style="color: black;">WeddingDress</h2>
	<div align="right" style="height: 25px;">
		<a href="/wedding/vender_dress">
			<abbr title="World Health Organization">처음 보기</abbr>
		</a>&nbsp;&nbsp;
		<a href="/wedding/vender_dress_weddingDress_selectName">
			<abbr title="World Health Organization">이름순 보기</abbr>
		</a>&nbsp;&nbsp;
		<a href="/wedding/vender_dress_weddingDress_selectPrice">
	...
	<div style="background-color: white;">
		...
		<c:choose>
			<c:when test="${ vender_dress != null }">
				<c:forEach var="each" items="${ vender_dress }">
					<div class="col-md-4">
			...
			<c:when test="${ vender_dress_weddingDress != null }">
				<c:forEach var="each" items="${ vender_dress_weddingDress }">
					<div class="col-md-4">
						<a href="" class="thumbnail" data-toggle="modal" data-target="#exampleModal" 
							onclick="javascript:govendermodal('${each.num}','${each.type}')">
							<img src="/wedding/resources/vender_gallery/vender_dress_gallery/${ each.orgname }" alt="Pulpit Rock" 
