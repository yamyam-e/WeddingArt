...
<div align="center">
	...
	<h2 style="color: DimGrey;" align="center" class="cursive">마음을 전하세요
		<img alt="" src="/wedding/resources/gift/gift_icon05.png">
	</h2>
</div>

<div class="col-sm-16" style="background-color: lavender; height: 3px;"></div>
	...
	<div style="height: 40px;position: relative;top: 35px;">
		<form action="/wedding/giftSearch" class="form-inline" >
			<div class="form-group">
				...
				<input type="hidden" name="type" value="Useful">
			</div>
		</form>
		<div class="dropdown" style="position: relative; bottom: 33px; left: 1040px;">
			...
			<ul class="dropdown-menu">
				...
				<li><a href="/wedding/gift_selectListP01?type=Useful">가격 오름차순</a></li>
				<li><a href="/wedding/gift_selectListP02?type=Useful">가격 내림차순</a></li>
				<li class="divider"></li>
				<li class="dropdown-header">이름순 보기</li>
				<li><a href="/wedding/gift_selectListN01?type=Useful">이름 오름차순</a></li>
				<li><a href="/wedding/gift_selectListN02?type=Useful">이름 내림차순</a></li>
			</ul>
		</div>
	</div>
</div>
