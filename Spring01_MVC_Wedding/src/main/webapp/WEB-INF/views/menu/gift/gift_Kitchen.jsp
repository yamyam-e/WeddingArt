...
<div class="col-sm-16" style="background-color: PowderBlue; height: 3px;"></div>
	...
	<div style="height: 40px;position: relative;top: 35px;">
		...
		<div class="dropdown" style="position: relative; bottom: 33px; left: 1040px;">
			...
			<ul class="dropdown-menu">
				...
				<li><a href="/wedding/gift_selectListP01?type=Kitchen">가격 오름차순</a></li>
				<li><a href="/wedding/gift_selectListP02?type=Kitchen">가격 내림차순</a></li>
				<li class="divider"></li>
				<li class="dropdown-header">이름순 보기</li>
				<li><a href="/wedding/gift_selectListN01?type=Kitchen">이름 오름차순</a></li>
				<li><a href="/wedding/gift_selectListN02?type=Kitchen">이름 내림차순</a></li>
			</ul>
		</div>
	</div>
</div>
