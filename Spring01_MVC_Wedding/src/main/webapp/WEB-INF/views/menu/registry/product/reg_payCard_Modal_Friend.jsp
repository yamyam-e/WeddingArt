...
<body>
<div class="modal fade" id="payCardModalForFriend" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/wedding/regPayCardForFriend" method="post">
							...
							<td>
								<c:choose>
									<c:when test="${ regcDTOForFriend != null }">
										...
										<input type="hidden" name="numOfMember" value="${ numOfMemberForOne }"/>
										<input type="text" name="payment"
											onchange="getNumber(this);" 
											onkeyup="getNumber(this);" 
											style="text-align:right;" size="10" value="${ regcDTOForFriend.total }">원
										<input type="hidden" name="name" value="${ regcDTOForFriend.name }">
										<input type="hidden" name="quantity" value="${ regcDTOForFriend.buyquantity }">
										<input type="hidden" name="category" value="gift_${ regcDTOForFriend.category }">
										<input type="hidden" name="num" value="${ regcDTOForFriend.num }">
									</c:when>
									<c:otherwise>
										<input type="hidden" name="payStyle" value="some"/>
										<input type="hidden" name="numOfMember" value="${ numOfMember }"/>
										<input type="text" name="payment"
											onchange="getNumber(this);" 
											onkeyup="getNumber(this);" 
