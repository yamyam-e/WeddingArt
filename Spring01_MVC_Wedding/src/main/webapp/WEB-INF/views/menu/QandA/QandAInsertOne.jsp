...
<div class="modal fade" id="QandAInsertPop" role="dialog"
	style="text-align: center;">
	<div class="modal-dialog"
		style="background-color: white; height: 300px; width: 600px;">
		<div class="modal-content">
			<div class="modal-body">
				<h2 style="color: dimgray"><strong>게시판 글쓰기</strong></h2>
				<div class="col-sm-15" style="background-color: PeachPuff; height: 3px;"></div><br>

<!-- 				<a href="/wedding/QandASelectAll"><abbr title="World Health Organization">게시판 글 전체보기</abbr></a> -->

				<form action="/wedding/QandAInsertOne" method="post">
