...
public class Vender_makeupDTO {
   ...
   public Vender_makeupDTO() {
      // TODO Auto-generated constructor stub
   }
   
   public Vender_makeupDTO(Integer num, String name, String content, String homeurl, String phone, String address,
         Integer judge) {
      super();
      this.num = num;
      this.name = name;
